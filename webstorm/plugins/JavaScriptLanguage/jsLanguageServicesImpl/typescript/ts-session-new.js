...
function getSessionNew(TypeScriptSession, TypeScriptProjectService, TypeScriptCommandNames, logger, host, ts_impl, defaultOptionsHolder, mainFile, projectEmittedWithAllFiles) {
    ...
    var IDESession = (function (_super) {
        ...
        IDESession.prototype.beforeFirstMessage = function () {
            var _this = this;
            if (defaultOptionsHolder != null && defaultOptionsHolder.options != null) {
    ...
    var isUseSingleInferredProject = defaultOptionsHolder != null ? defaultOptionsHolder.isUseSingleInferredProject : true;
    var session = new IDESessionImpl(host, cancellationToken, isUseSingleInferredProject, nullTypingsInstaller, Buffer.byteLength, process.hrtime, logger, true);
    return session;
}
