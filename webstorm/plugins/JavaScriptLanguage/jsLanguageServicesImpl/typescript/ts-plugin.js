...
var TypeScriptLanguagePlugin = (function () {
    function TypeScriptLanguagePlugin(state) {
        ...
        var commonDefaultOptions = this.getDefaultCommandLineOptions(state, ts_impl);
        ...
        this._session = this.getSession(ts_impl, loggerImpl, commonDefaultOptions, pathProcessor, mainFile, projectEmittedWithAllFiles);
    ...
    TypeScriptLanguagePlugin.prototype.getDefaultCommandLineOptions = function (state, ts_impl) {
        ...
        return commonDefaultOptions === null && isUseSingleInferredProject ? null : new ts_default_options_1.DefaultOptionsHolder(commonDefaultOptions, ts_impl, isUseSingleInferredProject);
    };
    ...
    TypeScriptLanguagePlugin.prototype.getSession = function (ts_impl, loggerImpl, commonDefaultOptions, pathProcessor, mainFile, projectEmittedWithAllFiles) {
        var sessionClass = ts_session_1.createSessionClass(ts_impl, loggerImpl, commonDefaultOptions, pathProcessor, projectEmittedWithAllFiles, mainFile);
        return ts_session_provider_1.getSession(ts_impl, loggerImpl, commonDefaultOptions, mainFile, projectEmittedWithAllFiles, sessionClass);
    };
